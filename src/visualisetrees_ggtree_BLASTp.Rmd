...
We highlight S. cerevisiae Ssd1, `NP_010579.1`, with a label.
...
ggt_Dis3groups_reroot_equalangle <- 
  ...
  scale_color_manual("Ortholog\ngroup",
    ...
    geom_tiplab2(aes(subset=(label=="NP_010579.1")),
                 label="Ssd1", colour="black")+ 
...
### Composite figure, Figure 1C and 1D  of manuscript

```{r figure1_Dis3clades,dependson=c("plot_Dis3groups_reroot_equalangle","seqlogo_activeRNIIgroup"), fig.height=3, fig.width=6}
figure1_Dis3cladesCD <- 
  cowplot::plot_grid(ggt_Dis3groups_reroot_equalangle,
                     ggs_activesitebygroup,
                     nrow=1,labels=c("C","D"))
figure1_Dis3cladesCD

ggsave(filename = here::here("figure","figure1_Dis3cladesCD.pdf"), 
       plot = figure1_Dis3cladesCD,
       width = 6, height = 3)
```
