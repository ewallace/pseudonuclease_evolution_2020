...
ggplot(dist_deltaNterm1to337,aes(x=ID2,y=ID1rev,fill=percid)) + 
  geom_tile() + 
...
plotdist_CSD12 <- 
ggplot(dist_CSD12,aes(x=ID2,y=ID1rev,,fill=percid)) + 
  geom_tile() + 
  scale_fill_gradient("Percent\nidentity",
                      low="white",high="darkblue",limits=c(0,100)) + 
  theme_void() + 
...
plotdist_RNII <- 
ggplot(dist_RNII,aes(x=ID2,y=ID1rev,fill=percid)) + 
  geom_tile() + 
